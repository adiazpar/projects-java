/* 
    ...
    This program serves as an introductory exercise to practice
...
public class DiazAlejandroAssignment1 
{
    public static void main(String[] args)
    {
        ...
        System.out.println("\tMy name is Alejandro Diaz.");
        ...
        System.out.println("Right now, I'm grabbing free files from thingiverse to print.");
        System.out.println("Later, I will learn how to use a 3D modeling software to create my own prints.");
